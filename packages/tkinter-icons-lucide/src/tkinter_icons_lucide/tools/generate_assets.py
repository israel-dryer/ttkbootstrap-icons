...
#
#     Reads `lucide.ttf` and `lucide.json` from `tkinter_icons.assets` and writes
#     them to this provider's package directory as `fonts/lucide.ttf` and `glyphmap.json`.
#     """
#     base_assets = files("tkinter_icons.assets")
...
#
# def main(argv=None):
#     parser = argparse.ArgumentParser(description="Generate Lucide assets for tkinter-icons.")
#     parser.add_argument(
#         "--out-dir",

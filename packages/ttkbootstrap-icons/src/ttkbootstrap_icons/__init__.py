...
One library; the icon sets are installed as extras::
    ...
    from ttkbootstrap_icons import MaterialIcon
...
(`ttkbootstrap_icons_mat` and friends) still works exactly as before — the
...
if TYPE_CHECKING:
    ...
    from ttkbootstrap_icons_bs import BootstrapIcon as BootstrapIcon
    from ttkbootstrap_icons_devicon import DevIcon as DeviconIcon
    from ttkbootstrap_icons_eva import EvaIcon as EvaIcon
    from ttkbootstrap_icons_fa import FAIcon as FontAwesomeIcon
    from ttkbootstrap_icons_fluent import FluentIcon as FluentIcon
    from ttkbootstrap_icons_fluent_reg import FluentRegularIcon as FluentRegularIcon
    from ttkbootstrap_icons_gmi import GMatIcon as GoogleMaterialIcon
    from ttkbootstrap_icons_ion import IonIcon as IonIcon
    from ttkbootstrap_icons_lucide import LucideIcon as LucideIcon
    from ttkbootstrap_icons_mat import MatIcon as MaterialIcon
    from ttkbootstrap_icons_meteocons import MeteoIcon as MeteoconsIcon
    from ttkbootstrap_icons_remix import RemixIcon as RemixIcon
    from ttkbootstrap_icons_rpga import RPGAIcon as RpgAwesomeIcon
    from ttkbootstrap_icons_simple import SimpleIcon as SimpleIcon
    from ttkbootstrap_icons_typicons import TypiconsIcon as TypiconsIcon
    from ttkbootstrap_icons_weather import WeatherIcon as WeatherIcon
...
def __getattr__(name: str) -> Any:
    ...
    Args:
        name: Attribute being looked up on `ttkbootstrap_icons`.

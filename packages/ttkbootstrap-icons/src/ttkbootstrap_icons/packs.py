...
`ttkbootstrap-icons` is one library, but its icon packs are separate
...
package the user has to know the name of::
    ...
    pip install "ttkbootstrap-icons[material]"
...
REPO_URL = "https://github.com/israel-dryer/ttkbootstrap-icons"
...
class Pack:
    ...
    Attributes:
        extra: The extra to install it with, as in `ttkbootstrap-icons[extra]`.
        ...
        provider: The provider name it registers under, used by the registry
            and the `ttkicons-metrics` tool.
        label: Human-readable name of the upstream icon set.
        alias: The name this class is exported as from `ttkbootstrap_icons`.
    ...
    def install_command(self) -> str:
        ...
        fails outright on `pip install ttkbootstrap-icons[material]`.
        """
        return f'pip install "ttkbootstrap-icons[{self.extra}]"'
    ...
    def import_statement(self) -> str:
        ...
        """
        return f"from ttkbootstrap_icons import {self.alias}"
...
KNOWN_PACKS: tuple[Pack, ...] = (
    Pack("bootstrap", "ttkbootstrap-icons-bs", "ttkbootstrap_icons_bs",
         "BootstrapIcon", "bootstrap", "Bootstrap Icons"),
    Pack("devicon", "ttkbootstrap-icons-devicon", "ttkbootstrap_icons_devicon",
         "DevIcon", "devicon", "Devicon", alias="DeviconIcon"),
    Pack("eva", "ttkbootstrap-icons-eva", "ttkbootstrap_icons_eva",
         "EvaIcon", "eva", "Eva Icons"),
    Pack("fluent", "ttkbootstrap-icons-fluent", "ttkbootstrap_icons_fluent",
         "FluentIcon", "fluent", "Fluent System Icons"),
    Pack("fluent-regular", "ttkbootstrap-icons-fluent-reg", "ttkbootstrap_icons_fluent_reg",
         "FluentRegularIcon", "fluent-regular", "Fluent System Icons (Regular)"),
    Pack("fontawesome", "ttkbootstrap-icons-fa", "ttkbootstrap_icons_fa",
         "FAIcon", "fontawesome", "Font Awesome 6 (Free)", alias="FontAwesomeIcon"),
    Pack("google-material", "ttkbootstrap-icons-gmi", "ttkbootstrap_icons_gmi",
         "GMatIcon", "gmi", "Google Material Icons", alias="GoogleMaterialIcon"),
    Pack("ionicons", "ttkbootstrap-icons-ion", "ttkbootstrap_icons_ion",
         "IonIcon", "ion", "Ion Icons"),
    Pack("lucide", "ttkbootstrap-icons-lucide", "ttkbootstrap_icons_lucide",
         "LucideIcon", "lucide", "Lucide Icons"),
    Pack("material", "ttkbootstrap-icons-mat", "ttkbootstrap_icons_mat",
         "MatIcon", "mat", "Material Design Icons", alias="MaterialIcon"),
    Pack("meteocons", "ttkbootstrap-icons-meteocons", "ttkbootstrap_icons_meteocons",
         "MeteoIcon", "meteocons", "Meteocons", alias="MeteoconsIcon"),
    Pack("remix", "ttkbootstrap-icons-remix", "ttkbootstrap_icons_remix",
         "RemixIcon", "remix", "Remix Icon"),
    Pack("rpg-awesome", "ttkbootstrap-icons-rpga", "ttkbootstrap_icons_rpga",
         "RPGAIcon", "rpga", "RPG Awesome", alias="RpgAwesomeIcon"),
    Pack("simple", "ttkbootstrap-icons-simple", "ttkbootstrap_icons_simple",
         "SimpleIcon", "simple", "Simple Icons"),
    Pack("typicons", "ttkbootstrap-icons-typicons", "ttkbootstrap_icons_typicons",
         "TypiconsIcon", "typicons", "Typicons"),
    Pack("weather", "ttkbootstrap-icons-weather", "ttkbootstrap_icons_weather",
...
def no_packs_message() -> str:
    ...
    lines = [
        ...
        "",
        "ttkbootstrap-icons is the renderer; the glyphs come from packs you add as extras:",
    ]
    commands = [(pack.install_command, pack.label) for pack in suggestions if pack]
    commands.append(('pip install "ttkbootstrap-icons[all]"', "every pack"))
